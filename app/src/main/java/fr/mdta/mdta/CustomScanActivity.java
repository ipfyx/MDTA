...
public class CustomScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScansApplications.add(new BlacklistedDeveloperScan(PackageInfoFactory.getInstalledPackages(this, false)));
        ...
        mScansWholeSystem.add(new BlacklistedDeveloperScan(PackageInfoFactory.getInstalledPackages(this)));
